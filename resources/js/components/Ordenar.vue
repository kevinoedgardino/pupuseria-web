<template>
      ...
      <div class="content" style="background-color: #454d55;">
        <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
          ...
          <v-card class="m-4 datos">
            ...
            <div class="m-4">
              <validation-provider v-slot="{ errors }" name="Nombre" rules="required|max:60">
                <v-text-field v-model="orden.nombre" :counter="60" :error-messages="errors" label="Nombre" filled
  ...
  regex: /^[0-9]+$/
          ...
          <v-card class="m-4" v-if="pupusas.length">
            <v-card-title>
            ...
            <v-list class="m-4">
              <v-list-tile v-for="(pupusa) in pupusas" :key="pupusa.id">
                <v-list-tile-action style="color: #fff">
                  <v-checkbox v-model="selected" :label="`${pupusa.nombre} - $${pupusa.precio}`" multiple
                    :value="pupusa" />
                </v-list-tile-action>
              </v-list-tile>
            </v-list>
          ...
          <v-card class="m-4" v-if="bebidas.length">
            <v-card-title>
              <b>Elige la bebida.</b>
              ...
              <v-list-tile v-for="bebida in bebidas" :key="bebida.id">
                <v-list-tile-action>
                  <div class="d-flex">
                    ...
                    <number-input :min="0" v-model="bebida.cantidad" id="ni" inline center rounded
